...
//    //______________________________________________
    ...
    public RelationBinaire avecBouclesbis() {
        RelationBinaire R =new RelationBinaire(this.n,true);
        RelationBinaire m=R.union(this);
        return m;
    }
...
//        //______________________________________________
    ...
    public RelationBinaire sansBouclesBis() {
        RelationBinaire R = new RelationBinaire(this.n,true);
        RelationBinaire m=this.difference(R);
        return R;
    }
...
//        //______________________________________________
    ...
    public RelationBinaire unionBis(RelationBinaire r) {
        boolean[][] m = opBool(this.matAdj,r.matAdj,1);
        RelationBinaire R = new RelationBinaire(m);
        return R;
    }
...
//        //______________________________________________
    ...
    public RelationBinaire intersectionBis(RelationBinaire r) {
        boolean[][] m = opBool(this.matAdj,r.matAdj,2);
        RelationBinaire R = new RelationBinaire(m);
        return R;
...
//        //______________________________________________
    ...
    public RelationBinaire complementaireBis() {
        boolean[][] m = opBool(this.matAdj,this.matAdj,3);
        RelationBinaire R = new RelationBinaire(m);
        return R;
    }
...
//        //______________________________________________
    ...
    public RelationBinaire differenceBis(RelationBinaire r) {
        boolean[][] m = opBool(this.matAdj,r.matAdj,4);
        m=opBool(m,m,3);
        RelationBinaire R = new RelationBinaire(m);
        return R;
    }
...
//        //______________________________________________
    ...
    public boolean estReflexiveBis() {
        if (this.estEgaleBis(this.avecBoucles())) {
            return true;
        } else return false;
    }
...
//        //______________________________________________
    ...
    public boolean estAntireflexiveBis() {
        if (this.estEgaleBis(this.sansBoucles())) {
            return true;
        } else return false;
    }
...
//        //______________________________________________
    ...
    public boolean estSymetriqueBis() {
        RelationBinaire trans= new RelationBinaire(transposee(this.matAdj));
        if(this.difference(trans).estVide()){
            return true;
        }
        else return false;
    }
...
//        //______________________________________________
    ...
    public boolean estAntisymetriqueBis() {
        RelationBinaire trans= new RelationBinaire(transposee(this.matAdj));
        if(this.difference(trans).estEgaleBis(this)){
            return true;
        }
        else return false;
    }
...
//        //______________________________________________
    ...
    public boolean estTransitive() {
        boolean estTransitive = true;
        int i = 0, j = 0,k=0;
        while (estTransitive && i < this.n) {
            while (estTransitive && j < this.n) {
                if (matAdj[i][j]) {
                    while(estTransitive && k<this.n){
                        if (matAdj[j][k]) {
    ...
    public boolean estTransitiveBis() {
        return this.ferTrans().estEgaleBis(this);
    }
...
//        //______________________________________________
    ...
    RelationBinaire produitRel(RelationBinaire r){
...
//        //______________________________________________
    ...
    public RelationBinaire ferTransBis() {
        RelationBinaire transitive= new RelationBinaire(this);
        for (int i=0;i<this.n;i++){
            RelationBinaire mult=new RelationBinaire(this);
            for (int j=0;j<i+1;j++){
                mult=mult.produitRel(this);
            }
            transitive=transitive.union(mult);
        }
        return transitive;
    }
...
//        //______________________________________________
    ...
    public void afficheDiversbis() {
        System.out.println(this);
        System.out.println("La R.B est :");
        if (this.estReflexiveBis()) {
            System.out.println("- réflexive");
        }
        if (this.estAntireflexiveBis()) {
            System.out.println("- antiréflexive");
        }
        if (this.estSymetriqueBis()) {
            System.out.println("- Symétrique");
        }
        if (this.estAntisymetriqueBis()) {
            System.out.println("- réflexive");
        }
        if (this.estTransitiveBis()) {
            System.out.println("- transitive");
        }
        if (this.estRelOrdreBis()) {
            System.out.println("- Une relation d'ordre");
        }
        System.out.println("----------------Hasse : --------------");
        System.out.println(this.hasse());
        System.out.println("--------------fermeture transitive de Hasse--------------- :");
        System.out.println(this.hasse().ferTransBis());
    }
    //-----------------------------------------------------------------------------

    public EE descendant(int x) {
        EE descendant = new EE(succ(x));
        for (int i = 0; i < this.n; i++) {
            if (descendant.contient(i)&&!succ(i).difference(descendant).estVide()){
                descendant = descendant.union(succ(i));
                i=0;
            }
        }
        return descendant;
